DanielHoldenSAOShader = {
	...
	fragmentShader: [
		...
		"	result.z = depth(uv)*(uCameraNear-uCameraFar)-uCameraNear;",
		"	return result;",
		"}",
		
		"uniform bool uNormalTexture;",
		"uniform vec2 uSize;",
		...
		"    vec2 indx = spiral(float(i+1)/float(uSamples+1), 2.5, 2.0*PI*seed.x);",
		"",
